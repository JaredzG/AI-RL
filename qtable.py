...
class Qtable:
  ...
  def update_qtable(self, position, action, layer, next_cell, next_actions, alpha, gamma, rl_method = 'q_learning', policy = 'p_random', carrying = False, next_pos_cells = None):
